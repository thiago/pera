var require = {
	paths: {
		// Pera
		'pera': 'pera',
		'pera.angular.app': 'pera/js/angular/app',
		...
		'moment.i18n': 'components/moment/min/lang',
		...
		'jquery.caroufredsel': 'components/carouFredSel/jquery.carouFredSel-6.2.1-packed',
		'jquery.mousewheel': 'components/carouFredSel/helper-plugins/jquery.mousewheel.min',
		'jquery.touchSwipe': 'components/carouFredSel/helper-plugins/jquery.touchSwipe.min',
		'jquery.transit': 'components/carouFredSel/helper-plugins/jquery.transit.min',
		...
		'jquery.ui.i18n': 'components/jquery-ui/ui/minified/i18n/',
	...
	shim: {
		...
		'jquery.ui.draggable': ['jquery', 'jquery.ui.core', 'jquery.ui.widget', 'jquery.ui.mouse'],
